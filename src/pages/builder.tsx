...
export default function BuildPage() {
  const [link, setLink] = React.useState(' https://texauhq.github.io/og/api/general');
  const [imgLink, setImgLink] = React.useState(
    ' https://texauhq.github.io/og/api/general'
  );
  ...
  React.useEffect(() => {
    ...
    const qurl = queryString.stringifyUrl(
      {
        url: ` https://texauhq.github.io/og/api/${ogType}`,
        query: { ...rest },
      },
      {
                ...
                <div className='grid md:grid-cols-[2fr,3fr] gap-8 items-center'>
                  <div className='flex flex-col gap-3 mt-8 md:max-w-sm'>
                    ...
                    <Input
                      id='logo'
                      label='Logo Links'
                      helperText='default:  https://texauhq.github.io/og/images/logo.png'
                    />
                    <Input
                      id='banner'
                      label='Banner Links'
